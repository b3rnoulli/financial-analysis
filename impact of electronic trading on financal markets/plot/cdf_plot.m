...
%     'SP500-removed',datetime('01-Jan-1950'), datetime('28-Dec-2016'), '^-', 'k', 'S&P500 1950-2017';
...
%     'NASDAQ-removed',datetime('01-Jan-1950'), datetime('28-Dec-2016'), '^-', 'k', 'NASDAQ 1950-2017';
...
%     
    ...
    '9-companies',datetime('01-Jan-1950'), datetime('28-Dec-2016'), '^-', 'k', '9-companies 1962-2017';
...
for i=1:1:length(indexes(:,1))
    ...
    cdf_plotter(f, returns, indexes{i,6}, indexes{i,4},indexes{i,5}, [], plot_reference);
