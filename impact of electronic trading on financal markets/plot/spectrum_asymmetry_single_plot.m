...
for i=1:length(indexes(:,1))
    ...
    plot(date_points,asymmetry,indexes{i,4},'MarkerSize',8, 'DisplayName',indexes{i,1});
    ...
    if save_figure == true
        savefig(f,[index_name,'-components-spectrum-asymmetry-',datestr(indexes{i,2},'yyyy-mm-dd'),'-', datestr(indexes{i,3},'yyyy-mm-dd')]); 
        print(f,[index_name,'-components-spectrum-asymmetry-',datestr(indexes{i,2},'yyyy-mm-dd'),'-', datestr(indexes{i,3},'yyyy-mm-dd')],'-depsc')
    end
