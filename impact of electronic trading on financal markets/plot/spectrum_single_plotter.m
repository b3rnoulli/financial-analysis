indexes = {
    ...
    'NASDAQ-removed',datetime('03-Jan-1950'), datetime('29-Dec-2016'), 'o-', 'k', 'NASDAQ COMP 1950-2017'
    };
...
for i=1:1:length(indexes(:,1))
    ...
    if save_figures == true
        savefig(f,[indexes{i,1},'-spectrum-',datestr(indexes{i,2},'yyyy-mm-dd'),'-', datestr(indexes{i,3},'yyyy-mm-dd')]); 
        print(f,[indexes{i,1},'-spectrum-',datestr(indexes{i,2},'yyyy-mm-dd'),'-', datestr(indexes{i,3},'yyyy-mm-dd')],'-depsc')
    end
